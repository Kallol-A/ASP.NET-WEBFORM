...
<%--                                        <asp:TemplateField HeaderText="Product Name">
                                        ...
                                        <asp:TemplateField HeaderText="Quantity">
                                            <ItemTemplate>
                                                <asp:Label ID="lblQuantity" runat="server" CssClass="text-right" Text='<%# Eval("quantity") %>' />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditQuantity" runat="server" CssClass="text-right" AutoPostBack="true" Text='<%# Bind("quantity") %>' OnTextChanged="UpdateAmountTextBox"></asp:TextBox>
                                            </EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Rate (₹)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditRate" runat="server" CssClass="text-right" AutoPostBack="true" Text='<%# Bind("rate") %>' OnTextChanged="UpdateAmountTextBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Discount (₹)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditDiscount" runat="server" CssClass="text-right" AutoPostBack="true" Text='<%# Bind("discount") %>' OnTextChanged="UpdateAmountTextBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Tax (₹)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditTax" runat="server" CssClass="text-right" AutoPostBack="true" Text='<%# Bind("tax") %>' OnTextChanged="UpdateAmountTextBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Amount (₹)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditAmount" runat="server" CssClass="text-right" Text='<%# Bind("amount") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:TemplateField>
                ...
                <asp:View ID="list_invoice" runat="server">
                    <div class="container">
                        ...
                        <h2>Invoice List</h2>
                        <div class="col-md-12">
                            <asp:GridView ID="gridViewInvoices" runat="server" AutoGenerateColumns="false" Width="100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <div style="text-align: center;">
                                                <asp:hyperlink id="lnkViewEdit" runat="server" NavigateUrl='<%# Eval("id", "invoiceEdit.aspx?id={0}") %>' > <asp:image id="img" runat="server" imageurl="images/edit.png" Height="30" Width="30" /></asp:hyperlink>
                                                <asp:ImageButton ID="btnDeleteInv" runat="server" ImageUrl="images/delete.png" Height="30" Width="30" CommandName="DeleteInv" OnClientClick="return confirm('Are you sure you want to delete this item?');" />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
